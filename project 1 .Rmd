...
chisq.test(`Patient  Depression rating based on image above`~'Group')
chisq.test(`Patient  Anxiety rating based on image above`~'Group')
chisq.test(`Patient  Pain rating based on image above`~'Group')
```
